...
public class UsuarioController {
    ...
    public ModelAndView grabarUsuario(@RequestParam("archivo") CommonsMultipartFile archivo, @Valid @ModelAttribute("usuarioBean") UsuarioEntity usuario, BindingResult resulta, ModelMap modelo) {
