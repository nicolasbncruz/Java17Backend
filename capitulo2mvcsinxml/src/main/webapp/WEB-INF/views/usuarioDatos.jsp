                ...
                <div class="col-md-6 col-xs-12 div-style">
                    <mvc:form modelAttribute="usuarioBean" action="usuarioGrabar.do">
                        <table>
                            ...
                            <tr>
                                <td><mvc:label  path="nombreApellido">Nombre Completo: </mvc:label></td>
                                <td><mvc:input  path="nombreApellido" cssErrorClass="form-control text-box formFieldError" cssClass="form-control text-box"/></td>
                                <td><mvc:errors path="nombreApellido" /></td>
                            </tr>
                            <tr>
                                <td colspan="1">
