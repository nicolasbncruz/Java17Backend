...
public class UsuarioController {
    ...
    public ModelAndView grabarUsuario(@RequestParam("accion") String accion, @RequestParam("archivo") CommonsMultipartFile archivo, @Valid @ModelAttribute("usuarioBean") UsuarioEntity usuario, BindingResult resulta, ModelMap modelo) {
